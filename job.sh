...
do
	...
	echo "./tracesim.o --cache-size 256 --cache-assoc 32 --core-num 8 --scheme 0 --trace-file /nv/hp20/tlin43/data/trace-with-eip-and-ifetch/${TRACE_FILE[$i]}.dramcache_trace --output-file /nv/hp20/tlin43/data/trace_usage/${TRACE_FILE[$i]}.dramcache_trace" >> ${TRACE_FILE[$i]}.pbs
